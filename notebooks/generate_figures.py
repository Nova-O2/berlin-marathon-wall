"""Generate manuscript figures 1, 2, 3 from the wall paper baseline dataset.

Figures 4 (fine-grained pacing) and 5 (temporal trend) are generated by their
respective analysis scripts (r1_pacing_fine_grained.py and r1_temporal_trend.py).

Figure 1: probability density of percentage slowdown by gender (with N + means + wall threshold)
Figure 2: bar plot of wall-hit prevalence by gender (Wilson 95% CI + significance bracket + OR)
Figure 3: stratified bars by performance category × gender (95% CI of mean + prevalence ratios)
...
if __name__ == "__main__":
    ...
    print("\n=== Generating Figure 1 (density) ===")
    figure_a_density(df)

    print("\n=== Generating Figure 2 (prevalence with Wilson 95% CI + OR bracket) ===")
    figure_b_prevalence(df)

    print("\n=== Generating Figure 3 (stratified with 95% CI of mean + prevalence ratios) ===")
    figure_c_stratified(df)

    print("\nFigures D and E are generated by their analysis scripts:")
    print("  - notebooks/r1_pacing_fine_grained.py → Figure_4_Pacing_Variability")
    print("  - notebooks/r1_temporal_trend.py → Figure_5_Temporal_Trend")
